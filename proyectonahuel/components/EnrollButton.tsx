...
const EnrollButton = ({ courseId, price, userHasCourse = false, label }: EnrollButtonProps) => {
  ...
  const buttonText = label || (price <= 0 ? 'Inscribirme gratis' : `Comprar por ${formattedPrice}`);
