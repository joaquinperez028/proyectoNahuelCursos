  ...
  return (
    <div className="bg-[var(--card)] rounded-xl border border-[var(--border)] p-6 mb-8">
      ...
      <div className="space-y-3">
        ...
        {isCompleted && progress.certificateIssued && progress.certificateUrl && (
          <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-green-800 font-medium">Certificado disponible</p>
                  <p className="text-green-600 text-sm">Tu certificado de finalización está listo</p>
                </div>
              </div>
              <a
