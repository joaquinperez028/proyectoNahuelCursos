      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <a 
                href="https://x.com/lozanonahuelok" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center px-4 py-2 bg-gray-800 rounded-md hover:bg-gray-700 text-gray-300 hover:text-green-500 transition-colors"
              >
              ...
              <a 
                href="https://www.instagram.com/lozanonahuel" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center px-4 py-2 bg-gray-800 rounded-md hover:bg-gray-700 text-gray-300 hover:text-green-500 transition-colors"
              >
              ...
              <a 
                href="https://www.youtube.com/@LozanoNahuel" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center px-4 py-2 bg-gray-800 rounded-md hover:bg-gray-700 text-gray-300 hover:text-green-500 transition-colors"
              >
              ...
              <a 
                href="https://www.tiktok.com/@lozanonahuelok" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-center justify-center px-4 py-2 bg-gray-800 rounded-md hover:bg-gray-700 text-gray-300 hover:text-green-500 transition-colors"
              >
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
            ...
            <Link href="/contacto" className="text-gray-400 hover:text-green-500 text-sm transition-colors">
              Contacto
            </Link>
          </div>
        </div>
