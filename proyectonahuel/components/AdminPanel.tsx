...
<<<<<<< HEAD
                  <div className="p-3 rounded-full bg-blue-500 bg-opacity-30 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd"/>
=======
                  <div className="p-3 rounded-full bg-blue-100 border-2 border-blue-200 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
>>>>>>> 066e7065dab7345002ec7c78d155c30d79e8388a
                    </svg>
                  </div>
                  <div>
              ...
              <div className="bg-[#1E1E2F] p-4 rounded-lg">
                <div className="flex items-center">
<<<<<<< HEAD
                  <div className="p-3 rounded-full bg-green-500 bg-opacity-30 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2 6a2 2 0 012-2h12a2 2 0 012 2v6a2 2 0 01-2 2H4a2 2 0 01-2-2V6zM14.553 7.106A1 1 0 0014 8v4a1 1 0 00.553.894l2 1A1 1 0 0018 13V7a1 1 0 00-1.447-.894l-2 1z"/>
=======
                  <div className="p-3 rounded-full bg-green-100 border-2 border-green-200 mr-4">
...
>>>>>>> 066e7065dab7345002ec7c78d155c30d79e8388a
              ...
              <div className="bg-[#1E1E2F] p-4 rounded-lg">
                <div className="flex items-center">
<<<<<<< HEAD
                  <div className="p-3 rounded-full bg-purple-500 bg-opacity-30 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
...
=======
                  <div className="p-3 rounded-full bg-purple-100 border-2 border-purple-200 mr-4">
...
>>>>>>> 066e7065dab7345002ec7c78d155c30d79e8388a
              ...
              <div className="bg-[#1E1E2F] p-4 rounded-lg">
                <div className="flex items-center">
<<<<<<< HEAD
                  <div className="p-3 rounded-full bg-yellow-500 bg-opacity-30 mr-4">
...
=======
                  <div className="p-3 rounded-full bg-yellow-100 border-2 border-yellow-200 mr-4">
